      ...
      <main className="pt-24 pb-16 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
            ...
            <section className="mb-12 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 backdrop-blur-sm flex flex-col">
              ...
              <div className="text-slate-300 lg:w-[330px] flex-shrink-0">
                ...
                <div className="space-y-2 text-slate-300 mb-2">
                  ...
                  <p>• {publicationsData.books.length} book chapter</p>
                  <p>
            ...
            <section className="mt-16">
              <h2 className="text-2xl font-bold text-slate-100 mb-8">Book chapters</h2>
              <div className="space-y-8">
                {publicationsData.books.map((book) => (
                  <div key={book.id} className="group">
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="text-[#89C3F9] font-mono text-sm">[B{book.id.toString().padStart(2, '0')}]</span>
                      <div className="text-slate-300">
                        <span dangerouslySetInnerHTML={{ __html: book.authors }} /> ({book.year})
                      </div>
                    </div>
                    <div className="ml-8 sm:ml-10">
                      <h3
                      ...
                      />
                      <div className="text-slate-400 text-sm mb-1">
                        In {book.editors} <span className="italic">{book.journal}</span> {book.pages}. {book.publisher}.
                      </div>
                      <div className="text-sm">
                        <span className="text-slate-500">doi: </span>
                        <a
